...
const TicketTable = ({ data }) => {
    ...
    const onPressViewOrderDetails = () => {
        navigation.navigate(NavigationStrings.HOME_STACK, {
            screen: NavigationStrings.VIEW_TICKET_SCREEN
        })
    }
    return (
        <View>
            <View style={[styles.row, styles.head]}>
                <Text style={[styles.headTxt, { width: COLUMN_WIDTHS.product }]}>Events</Text>
                        ...
                        <View style={[styles.row, styles.bodyRow]}>
                            <View style={[styles.userInfoContainer, { width: COLUMN_WIDTHS.product }]}>
                                ...
                                <View style={styles.userNameContainer}>
                                    <Text style={styles.userName}>{item.ticketType}</Text>
                                </View>
                            </View>

                            <Text style={[styles.status, { width: COLUMN_WIDTHS.quantity }]}>{item.quantity}</Text>
                            <Text style={[styles.status, { width: COLUMN_WIDTHS.date }]}>{item.eventDate}</Text>
