...
import BackpressTopBarWithNotificationAndThreeDots from '../../../components/framework/navbar/BackpressTopBarWithNotificationAndThreeDots'
...
import BookmarkTabDetails from '../profile-stack-screens/sub-screen/BookmarkTabDetails';
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.WHITE }}>
            ...
            >
                ...
                <View style={styles.btnContainer}>
                    <GradientTextButton width='25%' label='Subscribe' fontSize={14} />
                    <GradientTextButton width='25%' label='Message' fontSize={14} />
